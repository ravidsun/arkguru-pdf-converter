> Canonical copy: [`arkguru-pdf-converter/docs/DATABASE_SETUP.md`](https://github.com/ravidsun/arkguru-pdf-converter/blob/main/docs/DATABASE_SETUP.md) (this file is kept in sync).
...
| Local Docker ([compose.yaml](https://github.com/ravidsun/arkguru-pdf-converter/blob/main/compose.yaml)) | **5433** | `postgresql://rag:change-me@127.0.0.1:5433/rag` |
...
`.env` is gitignored. Copy [`.env.example`](https://github.com/ravidsun/arkguru-pdf-converter/blob/main/.env.example) → `.env`, or run
...
From `arkguru-pdf-converter` (requires Docker Engine or Desktop already installed):
...
That pulls `pgvector/pgvector:pg16`, starts [compose.yaml](https://github.com/ravidsun/arkguru-pdf-converter/blob/main/compose.yaml) on
...
[compose.yaml](https://github.com/ravidsun/arkguru-pdf-converter/blob/main/compose.yaml) on the VPS (still host port 5433 unless you
set `ARKGURU_PG_PORT`).
...
**`.env` (never commit secrets).** Copy [`.env.example`](https://github.com/ravidsun/arkguru-pdf-converter/blob/main/.env.example) →
...
- [compose.yaml](https://github.com/ravidsun/arkguru-pdf-converter/blob/main/compose.yaml) — local Docker pgvector
- [scripts/setup_docker_pg.sh](https://github.com/ravidsun/arkguru-pdf-converter/blob/main/scripts/setup_docker_pg.sh) — one-click pull, start, write `PG_DSN`
- [scripts/detect_local_pg.sh](https://github.com/ravidsun/arkguru-pdf-converter/blob/main/scripts/detect_local_pg.sh) — pick native vs Docker if already running
